...
namespace Labrys.Generation
{
    ...
    public class Feature
    {
        ...
        public List<Configuration> CanConnect(IReadOnlyGrid placedSections, Vector2Int gridPosition) 
        {
        ...
        public bool CanPlace(IReadOnlyGrid placedSections, Configuration configuration)
        {
        ...
        public bool CanPlace(IReadOnlyGrid placedSections, Vector2Int gridPosition, Vector2Int localPosition, int rotation)
        {
